...
const ApplicationsTable: React.FC = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      const response = await fetch(
        `https://hosho-digital-be.onrender.com/api/v1/scholarship-application/${id}/approve/hod`,
        {
          method: "PATCH",
      ...
      setData((prevData) =>
        prevData.map((application) =>
          application.id === id
            ? { ...application, status, hodFeedback: feedback }
            : application
        )
      );
      toast.success(
    ...
    <AppLayout>
      <div className="p-6 bg-white shadow-md rounded-lg mt-10 opacity-90">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl font-semibold text-[#725AC1]">Applications</h1>
        </div>
        <div className="flex justify-between items-center mb-4">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#725AC1] text-white">
                ...
                <th className="border-b p-2">HOD Feedback</th>
                  ...
                  <tr key={item.id} className="hover:bg-[#f0f0f5]">
                    ...
                    <td className="border-b p-2">
                      <input
                        ...
                        className="p-2 border rounded text-sm w-full"
                        placeholder="Enter HOD Feedback"
                      />
                    </td>
                    <td className="border-b p-2">
                      <DropdownMenu>
